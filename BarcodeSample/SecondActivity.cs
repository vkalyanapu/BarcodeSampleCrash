...
{
    [Activity(Label = "SecondActivity", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class SecondActivity : Activity, EMDKManager.IEMDKListener
    {
